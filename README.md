...
![Download count of latest release](https://img.shields.io/github/downloads/ben/foundry-supersworn/latest/ironsworn.zip?style=for-the-badge)
[![Forge Installs](https://img.shields.io/badge/dynamic/json?label=Forge%20Installs&query=package.installs&suffix=%25&url=https%3A%2F%2Fforge-vtt.com%2Fapi%2Fbazaar%2Fpackage%2Ffoundry-supersworn&style=for-the-badge)](https://forge-vtt.com/bazaar/package/foundry-supersworn)
...
```
https://github.com/ben/foundry-supersworn/releases/latest/download/system.json
```

For information on how to play a game, check out [the wiki](https://github.com/ben/foundry-supersworn/wiki/Getting-Started).
...
2. Install the main `foundry-supersworn` system, and create a world that uses it.
...
- Only the Javascript and stylesheets are served up by Vite. If you change anything else (like a `.hbs` file), you'll want to do something like this before reloading:
  ```
  cp -R system/* ~/Library/Application\ Support/FoundryVTT/Data/systems/foundry-supersworn/
  ```
...
Ocean scenes courtesy of [@AuguestBebel](https://github.com/AugustBebel) (https://github.com/ben/foundry-supersworn/pull/993).

Extra location icons courtesy of [Eric Rains and Kirin](https://github.com/ben/foundry-supersworn/pull/485).
